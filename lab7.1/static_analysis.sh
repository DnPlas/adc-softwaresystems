...
BIN_PATH=/home/daplascen/.local/bin
...
function run_sa(){
    ${BIN_PATH}/prospector > sa_logs/sa_prospector_$current_time.out
    ${BIN_PATH}/radon cc . > sa_logs/cc_radon_$current_time.out
    ${BIN_PATH}/radon raw . > sa_logs/raw_radon_$current_time.out
    ${BIN_PATH}/radon mi . > sa_logs/mi_radon_$current_time.out
    ${BIN_PATH}/radon hal . > sa_logs/hal_radon_$current_time.out
}
